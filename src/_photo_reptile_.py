...
# url = "https://api.unsplash.com/feeds/home"
...
#     print('图片ID:', each['id'])
#     try:
#         uri = "https://unsplash.com/photos/" + each['id'] + "/download?force=true"
#         print('uri == ', uri)
#         headers = {'authorization': 'Client-ID c94869b36aa272dd62dfaeefed769d4115fb3189a9d1ec88ed457207747be626',
#             'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36'}
#         pic = requests.get(uri, stream=True, headers=headers, verify=False, timeout=60)
#     except requests.exceptions.ConnectionError:
#         print('当前图片无法下载')
#         continue
#     file_name = each['id'] + ".jpg"
#     print(file_name)
#     fp = open("C:/Users/jiaop/Pictures/Python/" + file_name, 'wb+')
